                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('Contacto.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            placeholder="Nombre del estudiante" value="{{old('nombre')}}" required>
                        </div>

                        <div class="form-group">
                            <label for="apellido">Apellido:</label>
                            <input type="text" class="form-control" name ="apellido" id="apellido" minlength="3" maxlength="50"
                            placeholder="Apellido del estudiante" value="{{old('apellido')}}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            placeholder="example@mail.com" value="{{old('correo')}}" required>
                        </div>
